@echo off 
set /p APP_NAME=Enter the app name: 
...
mkdir %APP_NAME%\static\%APP_NAME%\images
mkdir %APP_NAME%\templates\%APP_NAME%\components
mkdir %APP_NAME%\templatetags
...
start https://django-tailwind.readthedocs.io/en/latest/installation.html
